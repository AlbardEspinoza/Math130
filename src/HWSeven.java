public class HWSeven { //This code was created by Albard Espinoza. Last time I worked on this code was 11/28/17 at 7:10P.M.
    public static void main(String[] args) {
        ...
        //System.out.println(a.getGrades());//Array variables stores an address. Remember you have to wrap it around an array function(click light bulb) for you to be able to print an array.
